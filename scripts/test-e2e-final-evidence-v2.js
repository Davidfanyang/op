...
async function main() {
  ...
  // ========================
  // 样本1：命中知识（lanton_transfer_success_not_received - 在白名单中）
  // ========================
  console.log('\n' + '═'.repeat(80));
  console.log('【样本 1】命中知识样本：lanton_transfer_success_not_received（在白名单）');
  console.log('═'.repeat(80));
  ...
  try {
    ...
    console.log('第一轮用户消息:', startResult2.userMessage);
